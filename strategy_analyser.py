...
def main():
    ...
    print (analyser.codes)
    print (analyser.number_of_games)
    print (analyser.mathematician_codebreaker_score)
    print (analyser.logician_codebreaker_score)
    print (analyser.random_codebreaker_score)
